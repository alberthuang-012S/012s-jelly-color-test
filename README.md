...
- Test flow: 2 control trials → selected-direction calibration → interleaved 2-down/1-up tracks → repeated-level anchor trials → analysis. The core quick session selects red-green bipolar and blue-yellow; purple-green and cyan-red are optional follow-up directions.
...
### Engine revision: `uv9-quick-core-optional`
