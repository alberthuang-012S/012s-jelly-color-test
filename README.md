...
- Test flow: 2 control trials → selected-direction calibration → interleaved 2-down/1-up tracks → repeated-level anchor trials → analysis. The core quick session selects red-green bipolar and blue-yellow; purple-green, red-orange-blue-green, yellow-green-blue-violet and red-violet-blue-green are optional follow-up directions.
