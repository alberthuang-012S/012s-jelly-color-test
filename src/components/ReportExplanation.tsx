  ...
  return (
    <section className="result-section report-explanation" aria-labelledby="report-explanation-title">
      ...
      <div className="report-reading-grid">
        ...
        <article><h3>03 / 品質等級與資料條件</h3><p>RQI ≥ 90：HIGH；75–89：GOOD；60–74：MODERATE；低於 60：LOW。這些是本工具的工程分級，用來描述本次資料狀態。低於 60 的紀錄保留，但不納入預設比較。</p><p>「資料不足」表示校準、有效觀察或估計條件未完成；該方向不列入整體門檻。A／B 保留相反色彩極性，C、D、E 補充藍黃、紫綠與青紅方向。</p><p>報告目前不提供常模或百分位。小數位數是顯示格式；單次數值請放在相同條件的個人紀錄中閱讀。</p></article>
