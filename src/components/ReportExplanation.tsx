  ...
  return (
    <section className="result-section report-explanation" aria-labelledby="report-explanation-title">
      ...
      <div className="report-reading-grid">
        ...
        <article><h3>03 / 品質等級與資料條件</h3><p>RQI ≥ 90：HIGH；75–89：GOOD；60–74：MODERATE；低於 60：LOW。這些是本工具的工程分級，用來描述本次資料狀態。低於 60 的紀錄保留，但不納入預設比較。</p><p>{isSupplemental ? '補充測驗只計算本次選定的方向，結果不會改寫核心快速版 dCDT。' : '核心快速版聚焦紅綠雙向軸與藍黃方向；紫綠與青紅可在結果頁另外選擇補充測量。'}</p><p>報告目前不提供常模或百分位。小數位數是顯示格式；單次數值請放在相同條件的個人紀錄中閱讀。</p></article>
